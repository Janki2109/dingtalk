...
class _AdminMeetingsScreenState extends State<AdminMeetingsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final results =
          await Future.wait([ApiService.getMeetings(), ApiService.getUsers()]);
      if (mounted)
        setState(() {
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        const Column(
                            ...
                            children: [
                              ...
                              Text('Create and start instantly',
                                  style: TextStyle(
                                      fontSize: 12,
                      ...
                      SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label:
                                Text(loading ? 'Creating...' : 'Create & Host'),
  ...
  void _showSchedule() {
    ...
    String fmtDate(DateTime dt) {
      ...
      return '${mo[dt.month - 1]} ${dt.day}, ${dt.year} · $h:${dt.minute.toString().padLeft(2, '0')} ${dt.hour < 12 ? 'AM' : 'PM'}';
    }
      ...
      builder: (_) => StatefulBuilder(
          builder: (ctx, setS) => Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const SizedBox(height: 8),
                  const Text('Share this code with employees to join',
                      style:
                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        ...
                        try {
                          ...
                          _snack('✅ Invite sent!', AppColors.online);
                        } catch (e) {
                          _snack('Failed: $e', AppColors.busy);
                        }
                      },
              ...
              : _meetings.isEmpty
                  ? Center(
                      child: Column(
                          ...
                          const SizedBox(height: 8),
                          const Text('Tap Host Meeting to create one',

...
class _WebRTCMeetingScreenState extends State<WebRTCMeetingScreen> {
  ...
  void initState() {
    ...
    // FIX BUG 23: catch errors from _connect and show feedback
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      ...
      child: Consumer<MeetingService>(builder: (ctx, svc, _) {
        ...
        // FIX BUG 20: handle rejected/removed/ended properly
        if (svc.status == MeetingStatus.rejected ||
            svc.status == MeetingStatus.removed ||
            svc.status == MeetingStatus.ended) {
          return Scaffold(
            ...
            body: Center(
              child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      svc.status == MeetingStatus.rejected
